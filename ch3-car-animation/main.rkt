...
; if mouse clicked, places the car at mouse position
; else does nothing
(check-expect (me-h 0 10 20 "button-down") 10)
(check-expect (me-h 0 10 20 "move") 0)
(define (me-h cw x y event) (if (equal? event "button-down") x cw))
